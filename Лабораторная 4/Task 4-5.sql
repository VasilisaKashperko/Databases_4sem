...
SELECT FACULTY.FACULTY [Факультет], PULPIT.PULPIT [Кафедра], PROFESSION.PROFESSION_NAME [Специальность], SUBJECT.SUBJECT_NAME [Предмет], STUDENT.NAME [Имя студента],
